...
if (
    ...
    isset($_POST['lawyer_name']) &&
    !isset($_POST['edit_lawyer_id']) &&
    check_admin_referer('hilton_manage_lawyer')
) {
...
if (
    $_SERVER['REQUEST_METHOD'] === 'POST' &&
    isset($_POST['client_names']) &&
    check_admin_referer('hilton_schedule_meeting', 'hilton_schedule_nonce')
) {
...
wp_nonce_field('hilton_manage_lawyer');
...
wp_nonce_field('hilton_schedule_meeting', 'hilton_schedule_nonce');
